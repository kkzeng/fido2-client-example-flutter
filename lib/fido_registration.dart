...
class FidoRegistration extends StatefulWidget {
  FidoRegistration({Key key, this.loggedInUser}) : super(key: key);
  String loggedInUser;
  @override
  _FidoRegistrationState createState() => _FidoRegistrationState();
}

class _FidoRegistrationState extends State<FidoRegistration> {
              ...
              children: [
                ...
                RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      User u = await _api.registerResponse(loggedInUser, _registerOptions.challenge, r.keyHandle, r.clientData, r.attestationObj);
                      if(u.error == null) {
                        setState(() {
                          status = 'Success!';
